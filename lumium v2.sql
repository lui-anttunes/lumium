...
create table outdoor( -- criando a tabela outdoor
	id int primary key auto_increment,
    id_cli int,
	foreign key(id_cli) references cliente(id), -- chave estrangeira, é  uma chave primaria vinda de outra tabela // id, chave da tabela cliente
...
insert into EntradasArduino values (null, 2, 1, 1000, '2020-02-20 15:30')
,(null, 2, 0, 900,'2020-06-06 07:34'), (null, 3, 2, 150, '2021-10-23 19:20')
; 
